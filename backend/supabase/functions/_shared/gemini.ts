...
- BODEGA: si "Bodega" esta en las categorias validas, van en "Bodega" las bolsas metalizadas para cafe (empaque del cafe en grano del tostador), la cinta adhesiva o de empaque (canela, transparente) con su despachador, y el playo stretch de rollo grande (18 cal 80 de 1300 pies). La pelicula para alimentos (clingfilm) y el playo de 1000 pies NO son de Bodega. Si "Bodega" no esta en la lista, todo eso va en "Desechables".
