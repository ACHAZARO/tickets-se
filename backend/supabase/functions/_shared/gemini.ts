...
- BODEGA: si "Bodega" esta en las categorias validas, van en "Bodega" las bolsas metalizadas para cafe (empaque del cafe en grano del tostador) y la cinta adhesiva o de empaque (canela, transparente) con su despachador. Si no esta, las bolsas y la cinta de empaque van en "Desechables".
