...
- BODEGA: si "Bodega" esta en las categorias validas, las bolsas metalizadas para cafe (empaque del cafe en grano del tostador) van en "Bodega". Si no esta, van en "Desechables".
