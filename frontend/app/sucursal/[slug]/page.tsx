...
export default function PinPage({ params }: PageProps) {
  ...
  return (
    <main className="flex min-h-screen min-h-[100dvh] flex-col items-center justify-center px-6 py-8 safe-top safe-bottom">
      <div className="flex w-full max-w-[20rem] flex-col items-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-5">
          ...
          {/* Dots */}
          <div
            className={`flex gap-3.5 ${shake ? 'animate-shake' : ''}`}
