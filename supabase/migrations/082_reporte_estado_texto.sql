-- 082: el reporte ticket por ticket trae `estado_texto` legible (Aprobado / Rechazado / Por revisar), para
-- ponerlo como 2a columna en el CSV de la API y en la hoja Tickets del Excel. Resto identico a 081.
